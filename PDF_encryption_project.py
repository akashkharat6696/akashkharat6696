...
class pdfEncryptor:
    ...
    def connect_to_db(self):
        ...
        global cnx
        global mycursor
        cnx = connection.MySQLConnection(user='dhoni', password='Lenovo@123', host='127.0.0.1', database='python')
        mycursor = cnx.cursor()
    ...
    def send_email(self,usermail):
        ...
        fromaddr = "akashkharat23@gmail.com"
        toaddr = usermail
...
def main():
    try:
        ...
        # folder=r"C:\Users\akash.kharat\PycharmProjects\pythonProject-2-3\pdf_to_ecrypt"
